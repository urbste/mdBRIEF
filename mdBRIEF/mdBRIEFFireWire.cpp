                  ...
                  int nrhs, const mxArray *prhs[] )
{
    ...
    cv::Vec<double, 5> cdeu0v0(0.997811026283848,
		-0.281428412128156,
		0.282519085611155,
		311.446804458526,
		231.919496651964);
	cv::Mat p(3, 1, CV_64FC1);
	p.at<double>(0) = -517.440277757948;
	p.at<double>(1) = 0.0;
	p.at<double>(2) = 0.000507713323185074;
	cv::Mat invP(5, 1, CV_64FC1);
	invP.at<double>(4) = 9.21536544378168;
	invP.at<double>(3) = 88.0873007571282;
	invP.at<double>(2) = 280.474000756768;
	invP.at<double>(1) = 889.213192347202;
	invP.at<double>(0) = 990.038880850094;
